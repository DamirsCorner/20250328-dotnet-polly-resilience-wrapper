...
{
    public class PollyDiWithPipelineProviderTests
    {
        ...
        {
            private readonly ResiliencePipeline rateLimitingPipeline = pipelineProvider.GetPipeline(
        ...
        [Test]
        public async Task InjectsProviderIntoService()
        {
